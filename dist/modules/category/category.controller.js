...
exports.create = (0, catchAsync_1.default)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, name, type, style, userId, category;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = req.body, name = _a.name, type = _a.type, style = _a.style, userId = _a.userId;
                return [4, _1.categoryService.create({
                        name: name,
                        type: type,
                        style: style,
                        userId: userId
...
exports.remove = (0, catchAsync_1.default)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4, _1.categoryService.remove({
                    id: req.params.id
                })];
            case 1:
                category = _a.sent();

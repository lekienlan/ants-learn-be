...
var findMany = function (filter, options) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4, category_model_1.default.paginate(filter, options)];
            case 1:
                categories = _a.sent();
                return [2, categories];
        }
...
var create = function (data) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4, category_model_1.default.create(__assign(__assign({}, data), { code: (0, lodash_1.snakeCase)((0, utils_1.removeDiacritics)(data.name)) }))];
            case 1:
                category = _a.sent();
                if (data.userId) {
                    return [2, category.populate('user')];
                }
                return [2, category];
        }
    });
...
var update = function (data) { return __awaiter(void 0, void 0, void 0, function () {
    var id, payload, category;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                id = data.id, payload = __rest(data, ["id"]);
                return [4, category_model_1.default.findByIdAndUpdate(id, __assign(__assign({}, payload), ((data === null || data === void 0 ? void 0 : data.name)
...
var remove = function (_a) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4, category_model_1.default.findByIdAndRemove(id)];
                case 1:
                    category = _b.sent();
                    if (!category)
                        throw new ApiError_1.default(http_status_codes_1.StatusCodes.NOT_FOUND, 'Category not found');

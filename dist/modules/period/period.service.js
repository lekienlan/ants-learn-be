...
var create = function (data) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4, prisma_1.default.periods.create({ data: data })];
            case 1:
                period = _a.sent();
                return [2, period];
        }
...
var update = function (id, data) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4, prisma_1.default.periods.update({ where: { id: id }, data: data })];
            case 1:
                period = _a.sent();
                if (!period)
                    throw new ApiError_1.default(http_status_codes_1.StatusCodes.NOT_FOUND, 'Period not found');
...
var remove = function (_a) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4, prisma_1.default.periods.delete({ where: { id: id } })];
                case 1:
                    period = _b.sent();
                    if (!period)
                        throw new ApiError_1.default(http_status_codes_1.StatusCodes.NOT_FOUND, 'Period not found');

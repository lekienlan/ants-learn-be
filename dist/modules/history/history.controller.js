...
exports.findTransHistories = (0, catchAsync_1.default)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var history;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4, _1.historyService.findTransHistories({
...
exports.create = (0, catchAsync_1.default)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4, _1.historyService.create(req.body)];
            case 1:
                history = _a.sent();
                res.status(http_status_codes_1.StatusCodes.CREATED).send(history);
                return [2];
        }
    });
}); });
exports.remove = (0, catchAsync_1.default)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4, _1.historyService.remove({
                    id: req.params.id
                })];
            case 1:
                history = _a.sent();

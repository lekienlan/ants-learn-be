...
var findMany = function (params, include) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4, (0, paginate_1.default)(prisma_1.default.histories, params, include)];
            case 1:
                list = _a.sent();
                return [2, list];
        }
...
var findTransHistories = function (_a) {
...
exports.findTransHistories = findTransHistories;
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    history = _b.sent();
                    if (!history)
                        throw new ApiError_1.default(http_status_codes_1.StatusCodes.NOT_FOUND, 'History not found');
                    return [2, history];
            }
        });
    });

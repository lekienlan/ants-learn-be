...
export interface ITransactionPayload extends Omit<ITransaction, 'user' | 'category'> {
}
export interface ITransactionUpdatePayload extends Omit<ITransactionPayload, 'userId'> {
    id: string;
}
...
export interface ITransactionModel extends Model<ITransactionDoc> {
    paginate(filter: Record<string, any>, options: IPaginateOptions): Promise<IPaginateResult<ITransactionDoc>>;
}
